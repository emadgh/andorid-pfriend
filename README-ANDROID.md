...
## Build
Requirements: JDK 17+, Android SDK 36, Build Tools 36.0.0, Gradle 9.5.0. The project uses AGP 9 built-in Kotlin with the Compose compiler plugin and the stable Compose BOM 2026.06.00.
